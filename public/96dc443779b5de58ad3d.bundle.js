...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/js/components/react-components/src/load-bar/load-bar.scss":
/*!******************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./src/js/components/react-components/src/load-bar/load-bar.scss ***!
  \******************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/js/components/wizard/_wizard.scss":
/*!******************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./src/js/components/wizard/_wizard.scss ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_index.LoadBar, null),
...
var _LoadBar = __webpack_require__(/*! ../components/react-components/src/load-bar/LoadBar.jsx */ "./src/js/components/react-components/src/load-bar/LoadBar.jsx");
...
_api2.default.setOptions({
    getToken: function getToken() {
        ...
        var token = typeof session.payload != 'undefined' ? session.payload.access_token : '';
        return 'Bearer ' + token;
    },
    onLoading: _LoadBar.setLoading,
    ...
    _createClass(SplitLayout, [{
        ...
        value: function onSettingsSelect(item) {
            switch (item.slug) {
                ...
                case "start_tutorial":
                    _bcReactSession.Session.setPayload({ show_tutorial: true });
                    this.props.history.push('/');
                    break;
                case "hide_tutorial":
                    _bcReactSession.Session.setPayload({ show_tutorial: false });
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.onRootLevel ? _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _index.DropLink,
                                { direction: 'up', dropdown: [{ label: 'Profile', slug: 'profile' }, { label: 'My Courses', slug: 'choose' }, this.state.student && this.state.student.show_tutorial ? { label: 'Hide Tutorial', slug: 'hide_tutorial' } : { label: 'Start Tutorial', slug: 'start_tutorial' }, { label: 'Logout', slug: 'logout' }],
...
var LoadBar = exports.LoadBar = __webpack_require__(/*! ./load-bar */ "./src/js/components/react-components/src/load-bar/index.js").default;
...
/***/ "./src/js/components/react-components/src/load-bar/LoadBar.jsx":
/*!*********************************************************************!*\
  !*** ./src/js/components/react-components/src/load-bar/LoadBar.jsx ***!
  \*********************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./load-bar.scss */ "./src/js/components/react-components/src/load-bar/load-bar.scss");
...
var setLoading = exports.setLoading = function setLoading(status) {
    dispatcher.dispatch(status);
};

var LoadBar = function (_React$Component) {
    _inherits(LoadBar, _React$Component);

    function LoadBar() {
        _classCallCheck(this, LoadBar);

        var _this = _possibleConstructorReturn(this, (LoadBar.__proto__ || Object.getPrototypeOf(LoadBar)).call(this));
    ...
    _createClass(LoadBar, [{
        ...
        value: function render() {
            ...
            if (this.props.component) {
                ...
                return _react2.default.createElement(Comp, this.state);
            }
            return _react2.default.createElement(
                'div',
                { className: 'load-bar' },
...
var NotificationStore = function (_EventEmitter) {
    ...
    function NotificationStore() {
        ...
        var _this2 = _possibleConstructorReturn(this, (NotificationStore.__proto__ || Object.getPrototypeOf(NotificationStore)).call(this));
...
/***/ "./src/js/components/react-components/src/load-bar/index.js":
/*!******************************************************************!*\
  !*** ./src/js/components/react-components/src/load-bar/index.js ***!
  \******************************************************************/
/*! no static exports found */
...
var _LoadBar = __webpack_require__(/*! ./LoadBar.jsx */ "./src/js/components/react-components/src/load-bar/LoadBar.jsx");

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_LoadBar).default;
  }
});
...
/***/ "./src/js/components/react-components/src/load-bar/load-bar.scss":
/*!***********************************************************************!*\
  !*** ./src/js/components/react-components/src/load-bar/load-bar.scss ***!
  \***********************************************************************/
/*! no static exports found */
...
// load the styles
var content = __webpack_require__(/*! !../../../../../../node_modules/css-loader!../../../../../../node_modules/sass-loader/lib/loader.js!./load-bar.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/js/components/react-components/src/load-bar/load-bar.scss");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: this.props.logoURL }),
          _react2.default.createElement(
            'h2',
    ...
    value: function login(e) {
      ...
      if (!errors) {
        ...
        this.props.onSubmit(this.username, this.password).catch(function (err) {
          _this2.setState({ errorMsg: [err.msg || err.message || err], pending: false });
        });
      } else this.setState({ errorMsg: errors, pending: false });
...
/***/ "./src/js/components/wizard/Wizard.jsx":
/*!*********************************************!*\
  !*** ./src/js/components/wizard/Wizard.jsx ***!
  \*********************************************/
/*! no static exports found */
...
exports.tutorialSteps = exports.Wizard = undefined;
...
var _reactJoyride = __webpack_require__(/*! react-joyride */ "./node_modules/react-joyride/es/index.js");
...
__webpack_require__(/*! ./_wizard.scss */ "./src/js/components/wizard/_wizard.scss");
...
var Beacon = function Beacon(props) {
    return _react2.default.createElement(
        "div",
        _extends({ className: "beacon" }, props),
        _react2.default.createElement("span", { className: "beaconOuter" }),
        _react2.default.createElement(
            "span",
            { className: "beaconInner" },
            _react2.default.createElement("i", { className: "fas fa-question" })
        )
    );
};
var locale = { back: 'Previous', close: 'Close', last: 'Finish Tutorial', next: 'Next', skip: 'Skip' };
...
var Wizard = exports.Wizard = function (_React$Component) {
    ...
    _createClass(Wizard, [{
        key: "cancelTour",
        value: function cancelTour() {
            _bcReactSession.Session.setPayload({
                show_tutorial: false
            });
            _api2.default.student().update('me', { show_tutorial: false }).then(function () {
                return window.location.reload();
            }).catch(function (err) {
                _bcReactNotifier.Notify.error("Unable to disable tutorial on the database");
            });
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(_reactJoyride2.default, {
                ...
                callback: function callback(_ref) {
                    ...
                    if (type == 'tour:end' && typeof step != 'undefined' && typeof step.nextSteps == 'string') _this2.setState({ nextStepGroup: step.nextSteps });else if (type == 'tour:end' && typeof step != 'undefined' && step.lastStep == true) _this2.cancelTour();else if (action == 'skip') _this2.cancelTour();
                }
            });
        }
    }], [{
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
            ...
            return {
                currentStepGroup: typeof prevState.nextStepGroup == 'string' ? prevState.nextStepGroup : window.location.pathname + window.location.hash,
                nextStepGroup: null
            };
        }
    }]);
...
Wizard.propTypes = {
    ...
    initialStepGroup: _propTypes2.default.string
};
Wizard.defaultProps = {
    run: true,
...
var getSteps = function getSteps(url) {
    if (!url) return [];

    for (var pattern in tutorialSteps) {
...
var tutorialSteps = exports.tutorialSteps = {
    ...
    "\/course\/(.*)#menu=syllabus$": [{
        ...
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                "h5",
                null,
                "The course is divided into several days, each day has a list of TODO's you must complete in chronological order."
            ),
            _react2.default.createElement(
                "h4",
                null,
    ...
    "\/course\/(.*)#second$": [{
        ...
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                "h3",
                null,
                "Click on My Journey to start your course."
            )
        ),
        placement: 'right',
        locale: { last: 'Next phase' }
    ...
    "\/course\/(.*)\/1#started$": [{
        ...
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    ": Small conceptual reads necesary to understand the exercises."
                ),
                _react2.default.createElement(
                    "li",
                    null,
                    ...
                    ": Small micro-targeted exercises with the purpose of addressing particular skills."
                ),
                _react2.default.createElement(
                    "li",
                    null,
                    ...
                    ": Real life projects to practice your skills."
                ),
                _react2.default.createElement(
                    "li",
                    null,
                    ...
                    ": Autograded quizzes ideal for self-assesment"
                )
            )
        ),
        placement: 'left',
        ...
        content: _react2.default.createElement(
            "div",
            null,
            "Click on each TODO, and you will see a drop-down with the actions related to the activity: Mark as read, watch a video, mark as done, etc."
        ),
        placement: 'left',
        disableBeacon: true
    }, {
        ...
        content: _react2.default.createElement(
            "div",
            null,
            "As you complete the TODO's the day's progress will show at the top."
        ),
        placement: 'left',
        disableBeacon: true
    }, {
        ...
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                "p",
                null,
                "Start completing your TODO's and write us an email if you have any questions!"
            )
        ),
        placement: 'center',
        lastStep: true,
    ...
    "\/course\/(.*)/1$": [{
        ...
        content: _react2.default.createElement(
            "h5",
            null,
            "Each day starts with a small description that gives you a little bit of context."
        ),
        placement: 'left',
        disableBeacon: true
    }, {
        ...
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                "h5",
                null,
                "Days are blocked by default, clicking on ",
                _react2.default.createElement(
                    "code",
                    null,
                    "Start Day"
                ),
                " will add the activities into your TODO's and enable all the day's content."
            ),
            _react2.default.createElement(
                "h3",
                null,
    ...
    "\/course\/[^#\/]+$": [{
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                "p",
                null,
                "If you are here is because you are interested in learning and improving your coding skills."
            ),
            _react2.default.createElement(
                "p",
                null,
                "The BreatheCode platform is a group of tools that we have been developing during many years to accelerate your coding education."
            )
        ),
        placement: "center",
        disableBeacon: true,
        ...
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                "p",
                null,
                "The right side of the screen will always be about navigation, you can look here to open new tutorials, exercises, projects, etc. "
            ),
            _react2.default.createElement(
                "h4",
                null,
...
/***/ "./src/js/components/wizard/_wizard.scss":
/*!***********************************************!*\
  !*** ./src/js/components/wizard/_wizard.scss ***!
  \***********************************************/
/*! no static exports found */
...
// load the styles
var content = __webpack_require__(/*! !../../../../node_modules/css-loader!../../../../node_modules/sass-loader/lib/loader.js!./_wizard.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/js/components/wizard/_wizard.scss");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
var Wrapper = function () {
    ...
    _createClass(Wrapper, [{
        key: 'calculatePending',
        value: function calculatePending() {
            for (var method in this.pending) {
                for (var path in this.pending[method]) {
...
var _faQuestion = __webpack_require__(/*! @fortawesome/fontawesome-free-solid/faQuestion */ "./node_modules/@fortawesome/fontawesome-free-solid/faQuestion.js");
...
*/
_fontawesome2.default.library.add(_faCheck2.default, _faGraduationCap2.default, _faPlay2.default, _faSpinner2.default, _faSearch2.default, _faGithub2.default, _faCog2.default, _faSync2.default, _faEllipsisV2.default, _faExternalLinkAlt2.default, _faArrowRight2.default, _faArrowLeft2.default, _faAngleDoubleDown2.default, _faAngleDoubleUp2.default, _faQuestion2.default);
...
var getCurrentPath = exports.getCurrentPath = function getCurrentPath() {
    ...
    var menuRegex = /menu=(.+)$/;
    var menuMatch = hash.match(menuRegex);

    var menu = !menuMatch ? null : menuMatch[1];
    ...
    return { day: day, type: type, course: course, view: view, pathname: pathname, hash: hash, menu: menu };
};
...
var _Wizard = __webpack_require__(/*! ../components/wizard/Wizard.jsx */ "./src/js/components/wizard/Wizard.jsx");
...
var CourseView = function (_Flux$View) {
  ...
  function CourseView() {
    ...
    _this.state = {
      ...
      runTutorial: false,
      currentCohort: null,
      menuItems: _menu.menuModes[context.path.menu] ? _menu.menuModes[context.path.menu] : _menu.menuModes.course,
      currentMenuOption: _menu.menuModes[context.path.menu] ? _menu.menuModes[context.path.menu][0] : _menu.menuModes.course[0],
      context: context
    };
    //this.sessionUpdated();
  ...
  _createClass(CourseView, [{
    ...
    value: function componentDidMount() {
      ...
      var state = {
        ...
        runTutorial: _typeof(_session.payload.show_tutorial) != undefined ? _session.payload.show_tutorial : true,
    ...
    value: function syllabusUpdated() {
      ...
      this.setState({ menuItems: _menu.menuModes.course, currentMenuOption: currentMenuOption });
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Wizard.Wizard, {
...
var DayView = function (_Flux$View) {
  ...
  _createClass(DayView, [{
      ...
      if (!this.stopDayChangeListener) {
        this.stopDayChangeListener = this.props.history.listen(function (location, action) {
          ...
          if (match) {
            ...
            if (parseInt(newDayNumber, 10) !== _this2.state.day.dayNumber) _this2.loadDay(newDayNumber);
          }
        });
      }
    }
    ...
    value: function loadDay() {
      ...
      if (singleDay) {
        if (singleDay.opened && singleDay.actionables) setTimeout(function () {
          return window.location.hash = "started";
        }, 500);
        this.setState({
          day: singleDay,
...
var LoginView = exports.LoginView = function LoginView(props) {
    return _react2.default.createElement(_index.Login, {
        onSubmit: function onSubmit(username, password) {
            return (0, _auth.login)(username, password, props.history);
        },
        logoURL: 'http://assets.breatheco.de/apis/img/images.php?blob&cat=icon&tags=breathecode,64',
        appName: "student",
        onForgot: function onForgot() {
            return props.history.push("/forgot");
        }
    });
};
var ForgotView = exports.ForgotView = function ForgotView(props) {
    return _react2.default.createElement(_index.Forgot, {
        onSubmit: function onSubmit(username) {
            return (0, _auth.remind)(username);
        },
        logoURL: 'http://assets.breatheco.de/apis/img/images.php?blob&cat=icon&tags=breathecode,64',
        appName: "student",
...
/******/ });
//# sourceMappingURL=96dc443779b5de58ad3d.bundle.js.map