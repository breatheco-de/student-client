...
var locale = { back: 'Previous', close: 'Close', last: 'Finish', next: 'Next', skip: 'Skip' };
...
var Wizard = exports.Wizard = function (_React$Component) {
    ...
    _createClass(Wizard, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactJoyride2.default, (_React$createElement = {
            ...
            }, _defineProperty(_React$createElement, "run", this.state.runTutorial), _defineProperty(_React$createElement, "callback", function callback(_ref) {
                var step = _ref.step,
                    type = _ref.type;

                if (type == 'tour:end' && typeof step != 'undefined' && typeof step.nextSteps == 'string') _this2.setState({ currentTutorialStep: step.nextSteps });
            }), _React$createElement));
        }
    }]);
    ...
    first: [{
        ...
        content: _react2.default.createElement(
            ...
            _react2.default.createElement(
                "p",
                null,
                "The right side of the screen will always be about navegation, you can look here to open new tutorials, exercises, projects, etc. "
            ),
            _react2.default.createElement(
                "h3",
                null,
