        ...
        <div className="form-signin text-center">
          ...
          {this.state.withEmail ?
            <form action="#" onSubmit={(e) => this.login(e)}>
            {
                ...
                <div>
                    <small><a target="_blank" href={`${apiUrl}/v1/auth/password/reset?url=${window.location.href}`}>Forgot Password</a> or <a href="#" onClick={() => this.setState({ withEmail: false })}>or login with Github</a></small>
                </div>
            </form>
            :
            <div>
                <a href={`${apiUrl}/v1/auth/github?url=${window.location.href}`} className="btn btn-lg btn-light btn-block"><i className="fab fa-github mr-2"></i>With Github</a>
